...
export type Witnesses<PS> = {
  ...
  localBalance(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, bigint];
}
...
export type PureCircuits = {
  ...
  commitBalance(balance_0: bigint): Uint8Array;
}
...
export type Circuits<PS> = {
  ...
  commitBalance(context: __compactRuntime.CircuitContext<PS>, balance_0: bigint): __compactRuntime.CircuitResults<PS, Uint8Array>;
}
